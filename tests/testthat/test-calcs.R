...
test_that("rates", {
  ...
  rates <-
    ...
    dplyr::left_join(x@OCR, by = c("measurement", "well")) |>
    dplyr::left_join(x@ECAR, by = c("measurement", "well"))
